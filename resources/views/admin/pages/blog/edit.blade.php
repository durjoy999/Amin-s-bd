                              ...
                              <div class="row">
                                  <div class="col-12 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" value="{{$blog->title ?? old('title') }}" placeholder="Enter Title" />
                                        @error('title')
                                ...
                                <div class="col-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-select">
                                            ...
                                            <option  value="Deactive" {{ ($blog->status == 'Deactive' ? "selected":"") }}>Deactive</option>
                                        </select>
                                        @error('status')
                                        <span class="text text-danger">{{$message}}</span>
                                        @enderror
                                  ...
                                  <div class="col-12 mb-4">
                                       ...
                                       <textarea name="description" id="your_summernote" class="form-control">{{ $blog->description ?? old('description')}}</textarea>
                                       @error('description')
                                       <span class="text text-danger">{{$message}}</span>
                                       @enderror
                                  </div>
