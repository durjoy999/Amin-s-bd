    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Service Details</h4>
        ...
        <!-- end page title -->
            <div class="container">
                <div class="row">
                  <div class="col-12">
                    <img src="{{ asset('photo') }}/{{ $service->image }}" alt="blog"  style="height:400px;">
                  </div>
            <div class="container mb-4 pt-5">
              <div class="row">
                ...
                <div class="co-4">
                    <h2>Created By:</h2>
                    <b>{{ $service->adminCreatedBy->name }}</b>
                </div>
                <div class="col-4">
                    <h2>Edited By:</h2>
                    @if ($service->edited_by==1)
                    <b>{{ $service->adminEditedBy->name }}</b>
                    @endif
                </div>
              </div>
            </div>
