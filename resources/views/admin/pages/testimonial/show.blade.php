    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Blog Testimonial</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <!-- end page title -->
            <div class="container">
                <div class="row">
                  <div class="col-12">
                    <img src="{{ asset('photo') }}/{{ $Testimonial->image }}" alt="Testimonial"  style="height:400px;">
                  </div>
            <div class="container mb-4 pt-5">
              <div class="row">
                ...
                <div class="co-4">
                    <h2>Created By:</h2>
                    <b>{{ $Testimonial->adminCreatedBy->name }}</b>
                </div>
                <div class="col-4">
                    <h2>Edited By:</h2>
                    <b>{{ $Testimonial->adminEditedBy->name }}</b>
                </div>
              </div>
            </div>
                  <div class="col-12">
