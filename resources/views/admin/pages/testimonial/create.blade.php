                              ...
                              <div class="row">
                                  ...
                                  <div class="col-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="reting" class="form-control" value="{{ old('reting') }}" placeholder="Enter Reting" />
                                        @error('reting')
                                        <span class="text text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                  ...
                                  <div class="col-6 mb-4">
                                        <label class="form-label">Image(size 40px * 40px)<span class="text-danger">*</span></label>
                                  ...
                                  <div class="col-6 mb-4">
                                    <div class="form-group">
                                        <label class="form-label">StatusDescription<span class="text-danger">*</span></label>
...
@section('admin_js')
    @if (Session::has('testimonial_create_success'))
    <script>
            Toast.fire({
                icon: 'success',
